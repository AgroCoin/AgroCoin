...
Contains files used to package agrocoind/agrocoin-qt
for Debian-based Linux systems. If you compile agrocoind/agrocoin-qt yourself, there are some useful files here.
...
### [RPM](/contrib/rpm) ###
RPM spec file for building bagrocoin-core on RPM based distributions.
